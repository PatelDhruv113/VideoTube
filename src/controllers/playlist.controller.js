...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
    ...
    if(!isValidObjectId(playlistId) || !isValidObjectId(videoId)){
        throw new ApiError(400, "Ivalid Playlist or VideoId")
    }
    ...
    if (!newPlaylist) {
        throw new ApiError( 500, "Error while Adding new video")
    }

    return res
    .status(200)
    .json(
        new ApiResponse(200, newPlaylist, "Video added")
    )
})
...
const removeVideoFromPlaylist = asyncHandler(async (req, res) => {
    ...
    const newPlaylistVideo = playList.videos.filter(v => String(v) !== String(videoId));
    ...
    .status(200)
    .json(
        new ApiResponse(200, updatePlaylistVideo , "removed video from playlist")
    )
})
...
const deletePlaylist = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, deletePlaylist, "Playlist Successfully Deleted")
    )
})
...
const updatePlaylist = asyncHandler(async (req, res) => {
    ...
    if(!(name || description)){
        throw new ApiError(400, "Please fill required details")
    }
